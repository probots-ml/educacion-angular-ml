...
export class FirstStepsComponent implements OnInit {
  ...
  descripciones = {
    ...
    ,probotlab: 'Descargue ProbotLab segun el tipo de ladrillo inteligente que posea.'
    ,probotlab_o1_1: 'Descargue ProbotLab para el kit R501 (Robótica educativa) del ladrillo inteligente R4 PIC, ejecútelo y siga los pasos del instalador.'
    ,probotlab_o2_1: 'Descargue ProbotLab para el kit R360 (Dinosaurios) del ladrillo inteligente R4 PIC, ejecútelo y siga los pasos del instalador.'
    ,probotlab_o3_1: 'Descargue ProbotLab para el kit R300 (Robot Escropion) del ladrillo inteligente R4 PIC, ejecútelo y siga los pasos del instalador.'
    ,probotlab_o4_1: 'Descargue ProbotLab para el kit R300 (puerto 232, versiones anteriores al 2013) del ladrillo inteligente R4 PIC, ejecútelo y siga los pasos del instalador.'
    ,antiguos: 'Seleccione el software a descargar.'
  };
  ...
  enlaces = {
    ...
    ,makecode_pp_4: new UnidadEnlace({enlace: 'https://misladrillos.com/ml/primeros-pasos-con-microbit-y-mis-ladrillos/', descripcion: 'Ir a la actividad'})
    ,makecode_pp_actividad: new UnidadEnlace({enlace: 'https://misladrillos.com/ml/proyectos/productos/microbit-trio-con-brazo/', descripcion: 'Ir a la actividad'})
    ...
    ,ardublock_r8sj: new UnidadEnlace({enlace: 'https://www.edubots.com.ar/ardublock/sj/ardublock.jar', descripcion: 'Descargar'})
    ,ardublock_r8p: new UnidadEnlace({enlace: 'https://misladrillos.com/descargas/probots/ardublock-all.jar', descripcion: 'Descargar'})
    ,ardublock_a: new UnidadEnlace({enlace: 'https://misladrillos.com/ml/proyectos/?plataforma=ardublock', descripcion: 'Ver actividades'})
    ,probotlab_o1_1: new UnidadEnlace({enlace: 'https://www.misladrillos.com/descargas/probots/ProbotLab%20EDU.exe', descripcion: 'Descargar'})
    ,probotlab_o2_1: new UnidadEnlace({enlace: 'https://www.misladrillos.com/descargas/probots/ProbotLab3.exe', descripcion: 'Descargar'})
  ...
  constructor() {
    this.paginaActual = "first-steps";
      ...
      */
      ...
      .agregarUnidad(new UnidadAsistente({id: 'opcion_inicio_o4', padre: 'inicio', siguiente: 'antiguos', descripcion: 'Archivos de software (ArduBlock, ProbotLab)'}))
      
      .agregarUnidad(new UnidadAsistente({id: 'antiguos', anterior: 'inicio', cabecera: 'Archivos de software (ArduBlock, ProbotLab)', titulo: 'Asistente para plataformas antiguas', descripcion: this.descripciones.antiguos}))
      .agregarUnidad(new UnidadAsistente({id: 'antiguos_o1', padre: 'antiguos', siguiente: 'ardublock', descripcion: 'ArduBlock'}))
      .agregarUnidad(new UnidadAsistente({id: 'antiguos_o2', padre: 'antiguos', siguiente: 'probotlab', descripcion: 'ProbotLab'}))
      ...
      //ardublock
      .agregarUnidad(new UnidadAsistente({id: 'ardublock', anterior: 'antiguos', siguiente: 'ardublock_1', cabecera: 'Descarga de software de Arduino', titulo: 'Ir al enlace de descarga de Arduino IDE', descripcion: this.descripciones.ardublock, enlace: this.enlaces.arduino}))
      ...
      //probotlab
      .agregarUnidad(new UnidadAsistente({id: 'probotlab', anterior: 'antiguos', cabecera: 'Seleccionar version de ProbotLab', titulo: 'Descarga de ProbotLab', descripcion: this.descripciones.probotlab}))
      .agregarUnidad(new UnidadAsistente({id: 'probotlab_o1', padre: 'probotlab', siguiente: 'probotlab_o1_1', descripcion: 'R501 (Robótica educativa)'}))
      .agregarUnidad(new UnidadAsistente({id: 'probotlab_o2', padre: 'probotlab', siguiente: 'probotlab_o2_1', descripcion: 'R360 (Dinosaurios)'}))
      .agregarUnidad(new UnidadAsistente({id: 'probotlab_o3', padre: 'probotlab', siguiente: 'probotlab_o3_1', descripcion: 'R300 (Robot Escorpion)'}))
      .agregarUnidad(new UnidadAsistente({id: 'probotlab_o4', padre: 'probotlab', siguiente: 'probotlab_o4_1', descripcion: 'R300 (Puerto 232, versiones anteriores al 2013)'}))
      
      .agregarUnidad(new UnidadAsistente({id: 'probotlab_o1_1', anterior: 'probotlab', siguiente: 'probotlab_1', cabecera: 'Descargar ProbotLab R501', titulo: 'Descarga de ProbotLab', descripcion: this.descripciones.probotlab_o1_1, enlace: this.enlaces.probotlab_o1_1}))
      .agregarUnidad(new UnidadAsistente({id: 'probotlab_o2_1', anterior: 'probotlab', siguiente: 'probotlab_1', cabecera: 'Descargar ProbotLab R360', titulo: 'Descarga de ProbotLab', descripcion: this.descripciones.probotlab_o2_1, enlace: this.enlaces.probotlab_o2_1}))
      .agregarUnidad(new UnidadAsistente({id: 'probotlab_o3_1', anterior: 'probotlab', siguiente: 'probotlab_1', cabecera: 'Descargar ProbotLab R300', titulo: 'Descarga de ProbotLab', descripcion: this.descripciones.probotlab_o3_1, enlace: this.enlaces.probotlab_o3_1}))
      .agregarUnidad(new UnidadAsistente({id: 'probotlab_o4_1', anterior: 'probotlab', siguiente: 'probotlab_1', cabecera: 'Descargar ProbotLab R300', titulo: 'Descarga de ProbotLab', descripcion: this.descripciones.probotlab_o4_1, enlace: this.enlaces.probotlab_o4_1}))
      
      
      
      .agregarUnidad(new UnidadAsistente({id: 'probotlab_1', anterior: 'probotlab', cabecera: 'Instalación de ProbotLab', titulo: 'Felicidades!', descripcion: 'Ya tiene todo lo necesario para programar, si lo desea puede revisar nuestras actividades.', enlace: this.enlaces.probotlab_1}))
